...
describe "Meeting waiting list" do # rubocop:disable RSpec/DescribeClass
  ...
  let!(:meeting) { create(:meeting, :published, component: component, questionnaire: questionnaire, waitlist_enabled: waitlist_enabled) }
  ...
  context "when the meeting is full and a user cancels their registration" do
    context "and there are users on the waiting list" do
      ...
      let(:users_on_waitlist) { create_list(:user, 5, :confirmed, organization: organization) }
