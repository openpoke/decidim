...
module Decidim::Meetings
  describe RegistrationsController do
    ...
    let(:meeting) { create(:meeting, :published, component: component, registrations_enabled: true, available_slots: 10) }
    ...
    describe "POST answer" do
      ...
      context "with valid params" do
        ...
        context "when joining waitlist" do
          let(:meeting) { create(:meeting, component: component, available_slots: 10, waitlist_enabled: true) }
          let!(:registrations) { create_list(:registration, 10, meeting: meeting) }
          let(:waitlist) { true }
